<template>
    <div>
        <p class="grey--text text--darken-1">Product Outbounds</p> 
        <v-card>
            <v-card-title>
            ...
            <v-card-text>
                <v-data-table
                    :loading="loading"
                    :headers="headers"
                    :items="getOutbounds.data"
                    :server-items-length="getOutbounds.total"
...
import FormModal from '../components/store-admin/product-outbound/FormModal'
import ViewInformation from '../components/store-admin/product-outbound/ViewInformation'
export default {
  components: { FormModal, ViewInformation },
    data () {
      return {
        ...
        headers: [
          ...
          { text: 'Price Type', value: 'price_type' },
          { text: 'Quantity', value: 'quantity' },
          { text: 'Amount', value: 'amount' },
          //{ text: 'Total Cost Price', value: 'total_cost_price' },
    ...
    methods: {
      ...
      getDataFromApi() {
        ...
        this.$store.dispatch('getOutbounds', params)
          .then(res => {
              this.loading = false
            console.log(res)
          })
